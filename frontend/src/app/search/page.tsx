    ...
    <main className="min-h-screen bg-[#f6f3ec] text-[#102a2f]">
      <header className="bg-[#102f35] text-white">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8 lg:px-10">
          ...
          <div className="flex items-center gap-1"><Button asChild variant="ghost" size="sm" className="text-white/75 hover:bg-white/10 hover:text-white"><Link href="/tracked"><Bell />Tracked</Link></Button><Button asChild variant="ghost" size="sm" className="text-white/75 hover:bg-white/10 hover:text-white"><Link href="/"><ArrowLeft className="size-4" aria-hidden />Modify search</Link></Button></div>
        </div>
      </header>
